...
def completare_registre(idff):
    ...
    if idff.loc[0, 'aparate'][9]:
        ...
        r9.loc[nr9, 'Denumire produs, Seria, Data fabricației'] = f'{idff.loc[0, "Produs"]}, {idff.loc[0, "Seria"]}, {idff.loc[0, "aparate1"][9]}'
    ...
    if idff.loc[0, 'aparate'][11]:
        ...
        r11.loc[nr11, 'Denumire produs/Seria și data fabricației'] = f'{idff.loc[0, "Produs"]}/ {idff.loc[0, "Seria"]}, {idff.loc[0, "aparate1"][11]}'
